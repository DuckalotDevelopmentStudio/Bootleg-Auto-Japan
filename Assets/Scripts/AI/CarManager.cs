...
public class CarManager : MonoBehaviour {
    ...
    public void Startup () {
        ...
        GameObject policeCars = GameObject.Find("Police Cars");
        cars = new GameObject[policeCars.transform.childCount];
        for (int i =0; i < policeCars.transform.childCount; i++)
        {
            cars[i] = policeCars.transform.GetChild(i).gameObject;
        }
    }
